...
def get_ei(ei_row):
    name = ei_row.Name
    icd = Array[String](ei_row.ICD.split('\r\n'))
    sqx = Array[String](ei_row.SQX.split('\r\n'))
    dmx = Array[String](ei_row.DMX.split('\r\n'))
    cg = Array[String](ei_row.CG.split('\r\n'))
    AlignList[name]=Align(name,icd,sqx,dmx,cg)




def get_distance(rmp, sta, ml='M1k'):
    """
    通过主线桩号，获取主线到匝道距离
    :param rmp: 匝道名称
    :param sta: 主线桩号
